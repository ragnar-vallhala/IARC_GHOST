...
namespace display {
    ...
    unsigned int state = 0, insert = 0,funct=0;
    ...
    void run() {
            ...
            if ((state >> 1) != 0) {
                ...
                if (insert == 1) {
                    ...
                    if (startOptionIndex != 0 && state > 3) {
                        ...
                        else if (state >> 3 == 2 && ((state >> 1) & 3) == 1) startOption::runData();
                        else if (state >> 3 == 3 && ((state >> 1) & 3) == 1) startOption::finalData();
                        else if (state >> 3 == 4 && ((state >> 1) & 3) == 1) startOption::trace();
                    ...
                    if ((state >> 3) == 0) {
                        ...
                        if ((state >> 5) == 0) {
                            ...
                            if (state >> 3 == 1) calibOption::curData();
                            else if (state >> 3 == 2) calibOption::newData();
                            ...
                            if ((state >> 5) == 0 && ((state >> 3) & 3) == 1) {
                                ...
                                if (insert == 1) {
                                    ...
                                    else if (state >> 5 == 3) calibOption::calibData::maxi();
                                    else if (state >> 5 == 4) calibOption::calibData::calib();
                                    /*  if (state >> 5 == 4 && (curCmd == 1 && prevCmd != 1)) {
                                          time = millis();
                                          insert = state;
                                          prevCmd = curCmd;
                                          state = 595;
                                      }
                                      if (state == 595 && time+4000<millis() ){
                                          commonScreen::loading();
                                      }
                                      else {
                                          state = insert;
                                ...
                                if (state >> 5 == 0) {
                                    ...
                                    else if (state >> 5 == 5) calibOption::calibData::save();
                                    if (state >> 5 != 0) {
                                        if (curCmd == 2 && prevCmd != 2) {
                                            state = 21;
                                            curCmd = prevCmd;
        ...
        if (state == 0) commonScreen::gadiNikal();
...
>>>>>>> 6c05f91995aaebc44da0bcaeb9d5e642bad60c7e
}
